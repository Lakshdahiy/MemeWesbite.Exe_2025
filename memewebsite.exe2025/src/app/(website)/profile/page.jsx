...
const handleDelete = async (postId) => {
  ...
  return (
    <div className="flex items-center min-h-screen bg-black">
      ...
      <div className="flex flex-col mx-auto md:mr-0 min-[1400px]:m-auto lg:mx-auto  justify-center p-4">
    ...
    {profile.posts && profile.posts.map(post => (
      ...
      >
        ...
        <span className="font-semibold text-white mt-5 text-center w-full ">
          {truncateString(post.Title, 15)}
        </span>
        <span className="text-gray-500 text-xs mb-5 mt-2 overflow-y-auto w-full text-center no-scrollbar">
          {truncateString(post.Caption, 35)}
        </span>
        <button 
